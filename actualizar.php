...
#uso actualizar.php?sat=BetterChangeMeNowOrSufferTheConsequences2
#echo $_SERVER['DOCUMENT_ROOT'];Cuidado, comprobar URL
#exit();
/**
 ...
 * @var string
 */
if (!defined('SECRET_ACCESS_TOKEN')) define('SECRET_ACCESS_TOKEN', 'BetterChangeMeNowOrSufferTheConsequences2');
/**
 ...
 * @var string
 */
if (!defined('REMOTE_REPOSITORY')) define('REMOTE_REPOSITORY', 'https://github.com/guaguasga/guagua.git');
/**
 ...
 */
if (!defined('TARGET_DIR')) define('TARGET_DIR', $_SERVER['DOCUMENT_ROOT'].'/guagua/');
/**
