...
class Zebra_Pagination
{
    ...
    {
        setcookie($this->_properties['cookie_page'],1);
    ...
    public function records($records)
    {
        ...
        public function fn_js_page($fn_js_page)
    {

        // funcion que ejecuta despues del evento onclick
    
        $this->_properties['fn_js_page'] = (string)$fn_js_page;

    }
    public function cookie_page($cookie_page="page")
    {

        // nombre de la cookie que graba la pagina
        
        $this->_properties['cookie_page'] = (string)$cookie_page;
    ...
    public function render2($return_output = false)
    {
        ...
        if ($this->_properties['reverse']) {
            ...
            if ($this->_properties['navigation_position'] == 'left')
                ...
                // first show next/previous and then page links
                $output .= $this->_show_next2() . $this->_show_previous2() . $this->_show_pages2();

            // if "next page" and "previous page" links are to be shown to the right of the links to individual pages
            elseif ($this->_properties['navigation_position'] == 'right')

                $output .= $this->_show_pages2() . $this->_show_next2() . $this->_show_previous2();

            // if "next page" and "previous page" links are to be shown on the outside of the links to individual pages
            else $output .= $this->_show_next2() . $this->_show_pages2() . $this->_show_previous2();
        ...
        // if we're showing records in natural order
            ...
            if ($this->_properties['navigation_position'] == 'left')
                ...
                // first show next/previous and then page links
                $output .= $this->_show_previous2() . $this->_show_next2() . $this->_show_pages2();

            // if "next page" and "previous page" links are to be shown to the right of the links to individual pages
            elseif ($this->_properties['navigation_position'] == 'right')

                $output .= $this->_show_pages2() . $this->_show_previous2() . $this->_show_next2();

            // if "next page" and "previous page" links are to be shown on the outside of the links to individual pages
            else $output .= $this->_show_previous2() . $this->_show_pages2() . $this->_show_next2();
    ...
    private function _show_next2()
    {
        ...
        if ($this->_properties['always_show_navigation'] || $this->_properties['total_pages'] > $this->_properties['selectable_pages'])
            ...
            // if we're on the last page, the link is disabled
            $output = '<li' . ($this->_properties['page'] == $this->_properties['total_pages'] ? ' class="disabled"' : '') . '><a onclick="grabarcookie(\''.$this->_properties['cookie_page'].'\',\'' .

                // the href is different if we're on the last page
                ($this->_properties['page'] == $this->_properties['total_pages'] ? 'javascript:void(0)' : $this->_properties['page'] + 1) . '\');'.$this->_properties['fn_js_page'].'"' .
    ...
    private function _show_pages2()
    {
        ...
        if ($this->_properties['total_pages'] <= $this->_properties['selectable_pages']) {
            ...
            for (
                ...
                // render the link for each page making sure to highlight the currently selected page
                $output .= '<li' . ($this->_properties['page'] == $i ? ' class="active"' : '') . '><a onclick="grabarcookie(\''.$this->_properties['cookie_page'].'\',\'' . $i . '\');'.$this->_properties['fn_js_page'].'">' .
        ...
        // if the total number of pages is greater than the number of selectable pages
            ...
            // start with a link to the first or last page, depending if we're displaying links in reverse order or not
            // highlight if the page is currently selected
            $output .= '<li' . ($this->_properties['page'] == ($this->_properties['reverse'] ? $this->_properties['total_pages'] : 1) ? ' class="active"' : '') . '><a onclick="grabarcookie(\''.$this->_properties['cookie_page'].'\',\'' . $this->_properties['reverse'] ? $this->_properties['total_pages'] : 1 . '\');'.$this->_properties['fn_js_page'].'">' .
            ...
            // put a link to the last/first page (depending on whether we're showing links in reverse order or not)
            // also, highlight if it is the currently selected page
            $output .= '<li' . ($this->_properties['page'] == $i ? ' class="active"' : '') . '><a onclick="grabarcookie(\''.$this->_properties['cookie_page'].'\',\'' . $this->_properties['reverse'] ? 1 : $this->_properties['total_pages'] . '\');'.$this->_properties['fn_js_page'].'">' .
    ...
    }private function _show_previous2()
    {
        ...
        if ($this->_properties['always_show_navigation'] || $this->_properties['total_pages'] > $this->_properties['selectable_pages'])
            ...
            // if we're on the first page, the link is disabled
            $output = '<li' . ($this->_properties['page'] == 1 ? ' class="disabled"' : '') . '><a onclick="grabarcookie(\''.$this->_properties['cookie_page'].'\',\''.

                // the href is different if we're on the first page
                ($this->_properties['page'] == 1 ? 'javascript:void(0)' : $this->_properties['page'] - 1) . '\');'.$this->_properties['fn_js_page'].'"' .
