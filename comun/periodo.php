...
<input type="image" src="img/eliminar.png" onClick="confirmeliminar2('periodo.php',{'del':'<?php echo $row['id_periodo'];?>'},'<?php echo $row['id_periodo'];?>');" value="Eliminar">
</td>
<?php } ?>
</tr>
<?php 
...
echo "</div>";echo '<div class="form-group"><p><label for="nombre_periodo">Nombre Período:</label><input class="form-control"name="nombre_periodo"type="text" id="nombre_periodo" value="';if (isset($row['nombre_periodo'])) echo $row['nombre_periodo'];echo '"';echo ' required ></p>';
echo "</div>";
